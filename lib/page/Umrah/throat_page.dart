...
class ThroatPage extends StatelessWidget {
        ...
        children: <Widget>[
          ...
          Padding( padding: const EdgeInsets.all(15.0),
            child: Material(
              ...
              shadowColor:Color(11111122222222222),
              borderRadius:BorderRadius.circular(5.0),
              child: const Center(child: Text('If he completes his quest, a man should shave his head or shorten his hair, even if a woman cuts the ends of her hair by the length of an inch on all sides of the head.\n\nThus, the Umrah is completed, and the Ihram is completely permitted, the prohibitions are lifted, and clothing, perfume, marriage, and other things are permitted for him.'
